...
<figure class="blog-figure blog-figure--lmp" style="max-width: 360px; margin: 1em auto 1.5em; text-align: center;">
  <img src="3bus.jpg" alt="Three-bus power system example with two generators and one load" width="360" style="width: 100%; max-width: 360px; height: auto;">
  <figcaption>Three-bus example used to illustrate congestion-driven LMP separation.</figcaption>
</figure>
